...
export const StoryViewer: React.FC<StoryViewerProps> = ({
  ...
  const renderStoryContent = () => {
      ...
      return (
        <div className="relative w-full h-full">
          <video
            ...
            loop
            onError={(e) => {
              console.error('❌ Failed to load story video:', currentStory.media_url);
            }}
          />
          {currentStory.content && (
    ...
    if ((currentStory.media_type === 'music' || currentStory.media_type === 'audio') && currentStory.media_url) {
      return (
        <div 
        ...
        >
          ...
          <audio
            ...
            autoPlay
            onError={(e) => {
              console.error('❌ Failed to load story audio:', currentStory.media_url);
            }}
          />
        </div>
      );
